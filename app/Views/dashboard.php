...
// Consulta para contar la cantidad de tickets
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3 id="todayTicketsCount"><?php echo $today_tickets_count; ?></h3>
...
<!-- SCRIPT PARA EL TODAYS TICKETS -->
<script src="../views/todaytickets.js"></script>
</body>
</html>
